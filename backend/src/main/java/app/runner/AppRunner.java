...
import static app.model.enums.CheckoutType.ONLINE;
import static app.model.enums.CheckoutType.UPFRONT;
import static app.model.enums.OrderState.*;
import static app.model.enums.Role.ADMIN;
...
public class AppRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Shop shop2 = new Shop("Phuoc shop", "https://down-bs-vn.img.susercontent.com/019ed89d540c28d61fbd0e29761ebd4a_tn", ShopType.ENTERTAINMENT_EDUCATION);
        Shop shop3 = new Shop("Hello world shop", "https://down-bs-vn.img.susercontent.com/019ed89d540c28d61fbd0e29761ebd4a_tn", ShopType.HOME_APPLIANCES);
